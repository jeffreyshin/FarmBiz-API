...
Original file is located at
    https://colab.research.google.com/drive/1WIts5IhWcKHATmBT-4CMKl9iWUp0PXzR
...
df = pd.read_csv("./data/data_gonju.csv")
# df = pd.read_csv("./data/kospi.csv")

scaler = MinMaxScaler()
df.columns = ["stn_no","stn_name","date","temperature","WS","RI","pressure", "humidity", "itemp", "ihumidity", "leafwet"]
df = df.drop(columns=["stn_no","stn_name","pressure"])

df[['temperature','humidity','WS', 'RI', 'itemp', 'ihumidity', 'leafwet']] = scaler.fit_transform(df[['temperature','humidity','WS', 'RI', 'itemp', 'ihumidity', 'leafwet']])
...
# Dataset
X = df[['temperature','humidity','WS','RI', 'itemp', 'ihumidity']].values
y = df['leafwet'].values
...
plt.plot(df['leafwet'][sequence_length:].values,'--')
